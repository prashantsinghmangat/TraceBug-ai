...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  // Footer
  html += `<div class="footer">Captured with <a href="https://tracebug.dev/?ref=pdf">TraceBug</a> — free · local-first · Session: ${session.sessionId.slice(0, 8)} · ${new Date(report.generatedAt).toLocaleString()}</div>\n`;
  html += `</body></html>`;
