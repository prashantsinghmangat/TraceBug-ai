...
<footer class="tb-ai-foot">Captured with <a href="https://tracebug.dev/?ref=ai-report" target="_blank" rel="noopener">TraceBug</a> — free · local-first · text-only AI report, safe to paste into a chat</footer>
</body>
</html>`;
}
